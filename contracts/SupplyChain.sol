...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  modifier sold(Item memory item){ require(item.state == State.Sold); _;}
  modifier shipped(Item memory item){ require(item.state == State.Shipped); _;}
  modifier received(Item memory item){ require(item.state == State.Received); _;}
